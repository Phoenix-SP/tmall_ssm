...
<div class="workingArea">
    <ol class="breadcrumb">
        <li><a href="admin_category_list" />所有分类</li>
    ...
    <table class="addPictureTable" align="center">
        <tr>
                    ...
                    <table class="table table-striped table-bordered table-hover table-condensed">
                        ...
                        <c:forEach items="${pisSingle}" var="pi">
                            <tr>
                                <td>${pi.id}</td>
                                <td>
                                    <a title="点击查看图片" href="img/productSingle/${pi.id}.jpg">
            ...
            <td class="addPictureTableTD">
                <div>
                    <div class="panel panel-warning addPictureDiv">
                        <div class="panel-heading">新增产品<b class="text-primary"> 详情 </b></div>
                        <div class="panel-body">
                            <form method="post" class="addFormDetail" action="admin_productImage_add" enctype="multipart/form-data">
                                <table class="addTable">
                                    ...
                                    <tr class="submitTR">
                                        <td align="center">
                                            <input type="hidden" name="type" value="type-detail" />
                                            <input type="hidden" name="pid" value="${p.id}" />
                    ...
                    <table class="table table-stripted table-bordered table-hover table-condensed">
                        <thead>
                        <tr class="success">
                            <th>ID</th>
                            <th>产品详情图片缩略图</th>
                        ...
                        <c:forEach items="${pisDetail}" var="pi">
                            <tr>
                                <td>${pi.id}</td>
                                <td>
                                    <a title="点击查看图片" href="img/productDetail/${pi.id}.jpg"><img height="50px" src="img/productDetail/${pi.id}.jpg"/> </a>
                                </td>
                                <td>
                                    <a deleteLink="true" href="admin_productImage_delete?id=${pi.id}" >
                                        <span class="glyphicon glyphicon-trash" />
